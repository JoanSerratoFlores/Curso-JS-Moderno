...
class AdminCitas {
  ...
  mostrar() {
    ...
    this.citas.forEach((cita) => {
      ...
      const contendeoBotones = document.createElement("div");
      contendeoBotones.classList.add("flex", "justify-between", "mt-10");

      contendeoBotones.appendChild(btnEditar);
      contendeoBotones.appendChild(btnEliminar);
      ...
      divCita.appendChild(contendeoBotones);
